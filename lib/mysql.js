...
/**
 * Custom error class for MySQL request errors
 */
...
class Mysql extends Sql {
     ...
     * @param {*} [type] SQL data type of input parameter. If you omit type, module automatically decides which MySQL data type should be used based on JS data type.
     * @param {*} value Input parameter value. `undefined` and `NaN` values are automatically converted to `null` values.
     * @throws {RequestError} When parameter name is invalid or insufficient arguments provided
     * @return {Request}
     */
